...
app.post('/api/students', async (req, res) => {
    ...
    try {
        // Amri ya SQL: Hakikisha majina haya (reg_no, etc) yanafanana na ulivyoandika pgAdmin
        ...
        console.log(`✅ Data Added: ${result.rowCount} row(s) affected.`); // Itakuandikia 1 row affected kwenye terminal
